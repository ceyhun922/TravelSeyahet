...
namespace TravelWeb.Areas.Admin.Controllers
{
    ...
    public class DashboardController : Controller
    {
        ...
        public DashboardController(IWriterService writerService, ITourService tourService, IRezervationService rezervationService, UserManager<Writer> userManager, ICommentService commentService, IDestinationService destinationService, Context context)
        {
        ...
        [HttpGet("/mostmadereservation")]
        public IActionResult MostMadeRezervation()
        {
